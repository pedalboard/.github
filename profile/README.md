...
|--------------------------------------------------------------------------|----------------------------------------------------------------------|-------|
| [Main Board](https://pedalboard.github.io/pedalboard-hw/latest/)        | CM4/CM5 carrier, RP-2040 MIDI controller, 6 buttons, 2 encoders     | ![30 deg View](https://pedalboard.github.io/pedalboard-hw/latest/3D/pedalboard-hw-3D_blender_30deg.png) |
| [Display Board](https://pedalboard.github.io/pedalboard-display/latest/)| 8 RGB LED rings + 2 OLED display ports                               | ![30 deg View](https://pedalboard.github.io/pedalboard-display/latest/3D/pedalboard-display-3D_blender_30deg.png) |
| [Sound Card](https://pedalboard.github.io/pedalboard-soundcard/latest/) | I²S audio codec HAT — PCM1863 ADC (106dB SNR) + PCM5242 DAC (112dB) | ![30 deg View](https://pedalboard.github.io/pedalboard-soundcard/latest/3D/pedalboard-soundcard-3D_blender_30deg.png) |
